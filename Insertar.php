...
echo($id);
    ...
    unset($_POST['id']);
    $videojuego->insertarVideojuego($_POST, $_FILES['imagen']);
   header('location:Catalogo.php');
}
}
        ...
        <form id="Form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" >
            <div class="form-row">
                <div class="form-group col-md-3 ml-auto">
                    ...
                    <input name="nombre" type="text" class="form-control" placeholder="Titulo del Videojuego" value="<?php echo($videojuego->getNombre())?>">
                </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-11 mr-auto">
                            ...
                            <select name="plataforma" class="custom-select">
                                <option value="0" selected><?php if($videojuego->getPlataforma() !="")echo($videojuego->getPlataforma()); else echo("Selecciona una Plataforma")?></option>
                                <?php
            ...
            <div class="form-row">
                <div class="form-group col-md-3 ml-auto">
                    ...
                    <input name="genero" type="text" class="form-control" value="<?php echo($videojuego->getGenero())?>" placeholder="Género del Videojuego">
                </div>
                <div class="form-group col-md-3 mr-auto">
                    <label class="font-weight-bold text-light">Fecha de Lanzamiento</label>
                    <input name="fecha" type="date" value="<?php echo($videojuego->getFecha())?>" class="form-control" placeholder="Fecha de Lanzamiento">
                </div>
            </div>
            <div class="form-row">
                ...
                <div class="form-group  col-md-3  ml-auto">
                    ...
                    <div class="star-rating form-group px-auto">
                        <fieldset id="Estrellas">
                            <input name="valoracion" <?php if($videojuego->getValoracion()==5)echo("checked") ?> type="radio" id="star5" name="rating" value="5"/><label for="star5"
                                                                                                             title="Fantastico!">5
                                stars</label>
                            <input name="valoracion"<?php if($videojuego->getValoracion()==4)echo("checked") ?>  type="radio" id="star4" name="rating" value="4"/><label for="star4"
                                                                                                             title="Muy Bueno">4
                                stars</label>
                            <input name="valoracion"<?php if($videojuego->getValoracion()==3)echo("checked") ?>  type="radio" id="star3" name="rating" value="3"/><label for="star3"
                                                                                                             title="Bueno">3
                                stars</label>
                            <input name="valoracion"<?php if($videojuego->getValoracion()==2)echo("checked") ?>  type="radio" id="star2" name="rating" value="2"/><label for="star2"
                                                                                                             title="Malo">2
                                stars</label>
                            <input name="valoracion"<?php if($videojuego->getValoracion()==1)echo("checked") ?>  type="radio" id="star1" name="rating" value="1"/><label for="star1"
                                                                                                             title="Muy Malo">1
                                star</label>
                        </fieldset>
                    </div>
